...
namespace notienendqver.Controllers
{
    public class AlmacensController : Controller
    {
        ...
        public AlmacensController(AcroxOgContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CodAlmacen,NombreAlmacen,LugarAlmacen,FechaCreacion")] Almacen almacen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CodAlmacen,NombreAlmacen,LugarAlmacen,FechaCreacion")] Almacen almacen)
        {
        ...
        {
            return _context.Almacens.Any(e => e.CodAlmacen == id);
        }
    }
}
